...
bin/main: obj/menu.o obj/isSupervisor.o obj/getArrow.o obj/menuList.o obj/blinksManager.o
	ld -m elf_i386 obj/isSupervisor.o obj/getArrow.o obj/menu.o  obj/menuList.o obj/blinksManager.o -o bin/main
