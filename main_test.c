...
int main(int argc, char *argv[])
{
    ...
    // Counter del menu
    int menuCounter = 0;
    // array delle voci del menu utente
    char *menuString[6] = {"Setting automobile:", "Data:", "Ora:", "Blocco automatico porte:", "Back-home:", "Check olio"};
    // array delle voci del menu supervisor
    char *menuStringSupervisor[8] = {"Setting automobile:", "Data:", "Ora:", "Blocco automatico porte:", "Back-home:", "Check olio", "Frecce direzione:", "Reset pressione gomme:"};
        ...
        while(1){
            ...
            if (ch == '\e')
            {
                ...
                case 'A':
                    ...
                    if (!moreDetails)
                    {
                        menuCounter > 0 ? menuCounter-- : menuCounter ==0 ? menuCounter=5 : menuCounter++;
                ...
                case 'B':
                    ...
                    if (!moreDetails)
                    {
                        menuCounter < 5 ? menuCounter++ : menuCounter ==5 ? menuCounter=0 : menuCounter;
                    }else{
                        modify = 1;
                    }
                    break;
...
//#######################################################################################
    ...
    if(isSuperVisor){//MENU SUPERVISOR  
        while(1){
            // flag che serve per modificare l'impostazione
            // 0 no modifiche 1 modifiche
            int modify = 0;
            ...
            if (ch == '\e')
            {
                ...
                case 'A':
                    ...
                    if (!moreDetails)
                    {
                        menuCounter > 0 ? menuCounter-- : menuCounter ==0 ? menuCounter=7 : menuCounter++;
                    }else{
                        modify = 1;
                    }
                ...
                case 'B':
                    ...
                    if (!moreDetails)
                    {
                        menuCounter < 7 ? menuCounter++ : menuCounter ==7 ? menuCounter=0 : menuCounter;
                    }else{
                        modify = 1;
                    }
                    break;
                case 'C':
                    clrscr();
                    if (menuCounter == 3 || menuCounter == 4 || menuCounter == 6 || menuCounter == 7)
                    {   
                        moreDetails = 1;
                    }
                    break;
                ...
                {
                case 0:
                    printf("%d: %s ", menuCounter, menuStringSupervisor[menuCounter]);
                    if (isSuperVisor)
                    {
                        printf("(supervisor)\n");
                    }
                ...
                case 3:
                    if (moreDetails)
                    {
                        ...
                        printf("%s (modifica) ",menuStringSupervisor[menuCounter]);
                        if (porte)
                        {
                            printf("ON\n");
                        }else
                ...
                case 4:
                    ...
                    break;
                case 5:
                    printf("%d: %s\n", menuCounter, menuStringSupervisor[menuCounter]);
                    break;
                case 6://freccieDirez
                    if (moreDetails)
                    {
